...
namespace MyTinySTL{
    ...
    template <class Category, class T, class Distance = ptrdiff_t,
     ...
     struct iterator{
        ...
        typedef Distance                      difference_type;   // 保存两指针减法操作结果
     };
    ...
    public m_bool_constant<is_input_iterator<Iterator>::value ||
        is_out_iterator<Iterator>::value> {};
    ...
    public:
        ...
        typedef typename iterator_traits<Iterator>::difference          difference_type;
